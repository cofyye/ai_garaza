...
import { MapPin, Briefcase, Building2, ChevronDown, ChevronUp, Calendar, Users, ArrowRight } from "lucide-react";
              ...
              <React.Fragment key={job.id}>
                ...
                >
                  <td className="px-6 py-4">
                    <div>
                      <h3 className="font-bold text-gray-600 group-hover:text-black transition-colors">{job.title}</h3>
                ...
                <AnimatePresence>
                  {isExpanded && (
                    <tr>
                      <td colSpan={6} className="p-0 border-b border-gray-100 bg-gray-50/50">
                        <motion.div
                          ...
                          <div className="px-6 pb-6 pt-2">
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                        ...
                                        <div>
                                            ...
                                            <div className="flex flex-wrap gap-2">
                                                {job.tech_stack.map((tech, i) => (
                                                    <span key={i} className="px-2 py-1 bg-white border border-gray-200 rounded text-xs text-gray-600 font-medium">
                                                        {tech}
                                                    </span>
                                                ))}
                                            </div>
                                ...
                                <div className="flex flex-col justify-end items-start md:items-end">
                                    <Button onClick={() => onSelectJob(job)} className="gap-2">
