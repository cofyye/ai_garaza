  ...
  return (
    <div>
      ...
      {filteredJobs.length > 0 ? (
        ...
        <EmptyState 
           title="No jobs found" 
           description={jobs.length === 0 ? "Create a new job post to get started." : "No jobs match your search criteria."} 
           actionLabel={filters.search ? "Clear Search" : undefined}
           onAction={filters.search ? () => setFilters({ search: "", status: "ALL" }) : undefined}
        />
      )}
    </div>
  );
